...
def RSS_scraper(url):
  ...
  csv_url = "https://raw.githubusercontent.com/treequeen/concordia-work-notices/main/notices.csv" # Make sure the url is the raw version of the file on GitHub
